"""
Django settings for walkietrackie project.
...
SECRET_KEY = '__3udgbv=s&4cxd26n^2uz%j_=pnm)=lz9=_=*1k9z)_y_q_qy'
...
ROOT_URLCONF = 'walkietrackie.urls'

WSGI_APPLICATION = 'walkietrackie.wsgi.application'
